  ...
  return (
    <div  id={styles.body}>
      <Head>
        ...
        <meta name="description" content="Política Privacidade" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <h1>Política Privacidade</h1>
        <p>A sua privacidade é importante para nós. É política do rsanttos respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site rsanttos, e outros sites que possuímos e operamos.</p>
        ...
        <h2>Política de Cookies rsanttos</h2>
        ...
        <h2>Cookies relacionados ao login</h2>
        ...
        <h2>Cookies relacionados a boletins por e-mail</h2>
        ...
        <h2>Cookies de preferências do site</h2>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o rsanttos oferece no site e com caráter enunciativo, mas não limitativo:</p>
        ...
        <p>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do rsanttos, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.
        Mais informações</p>

        <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>

        <p>Esta política é efetiva a partir de March/2022.</p>
      </main>
    </div>
  )
